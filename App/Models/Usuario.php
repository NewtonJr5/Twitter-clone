...
class Usuario extends Model {
	...
	public function seguir ($id_seguindo) {
		$query = "insert into usuario_seguidores (id_usuario, id_usuario_seguindo) values (:id, :id_seguindo)";
	...
	public function deixar_de_seguir ($id_seguindo) {
		$query = "delete from usuario_seguidores where id_usuario = :id and id_usuario_seguindo = :id_seguindo";
